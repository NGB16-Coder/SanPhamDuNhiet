...
<head>
    ...
    <title>Website bán sản phẩm giữ nhiệt Fpoly</title>
                        ...
                        <div class="product-container">
                            ...
                            <div class="product-tab-menu">
                                <ul class="nav justify-content-center">
                                    <li><a href="#tab1" class="active" data-bs-toggle="tab">Bình giữ nhiệt</a></li>
                                    <li><a href="#tab2" data-bs-toggle="tab">Cốc giữ nhiệt</a></li>
                                </ul>
                            </div>
